        ...
        <nav className="fixed top-0 left-0 right-0 z-50 bg-black/80 backdrop-blur-md border-b border-white/10">
            <div className="container mx-auto px-6 h-20 flex items-center justify-between">
                ...
                <Link
                    ...
                    target="_blank"
                    className="hidden md:block bg-white text-black px-6 py-2.5 font-bold uppercase hover:bg-primary hover:text-white transition-colors duration-300"
                >
                    Book Demo
                </Link>
            ...
            {/* Mobile Menu */}
            <div
                className={`md:hidden absolute top-20 left-0 right-0 bg-black/95 backdrop-blur-md border-b border-white/10 transition-all duration-300 overflow-hidden ${isOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'
                    }`}
            >
